...
INSERT INTO `classifier` VALUES (0,0,'Значение не определено',NULL),(1,1,'Константы системы',NULL),(1,2,'Роли пользователей','ROLE'),(1,3,'Типы туров','TOUR'),(1,4,'Тип транспорта','TRANSPORT'),(1,5,'Тип питания','FOOD'),(1,6,'Статус тура','STATE'),(1,7,'Категория отеля',NULL),(1,8,'Тип экскурссии по продолжительности','DURATION'),(1,9,'Направление оздоровления',NULL),(1,10,'Тип номера по принципу размещения','ROOM_TYPE_LOCATION_PRINCIPLE'),(1,11,'Тип номера по виду из окна','ROOM_TYPE_BY_VIEW'),(1,12,'Тип экскурссии по возрастучастников',NULL),(1,13,'Статус заказа',NULL),(2,1,'Администратор','ROLE_ADMIN'),(2,2,'Менеджер','ROLE_MANAGER'),(2,3,'Клиент','ROLE_CLIENT'),(3,1,'Отдых','REST'),(3,2,'Экскурссия','EXCURSION'),(3,3,'Оздоровление','THERAPY'),(4,1,'Самолет','AIRPLANE'),(4,2,'Поезд','TRAIN'),(4,3,'Автобус','BUS'),(4,4,'Лайнер','SHIP'),(5,1,'Room only','RO'),(5,2,'Bed & breakfast','BB'),(5,3,'Half board','HB'),(5,4,'Full board','FB'),(5,5,'All inclusive','AI'),(5,6,'Ultra all inclusive','UAI'),(6,1,'Активный',NULL),(6,2,'Горящий',NULL),(6,3,'Забронирован',NULL),(6,4,'Оплачен',NULL),(6,5,'Аннулирован',NULL),(7,1,'5*',NULL),(7,2,'4*',NULL),(8,1,'Однодневные',NULL),(8,2,'Выходного дня',NULL),(8,3,'Многодневные',NULL),(10,1,'Однокомнатный одноместный','SINGLE'),(10,2,'Однокомнатный двухместный','DOUBLE'),(10,3,'Трехместный','TRIPLE'),(11,1,'С видом на бассейн','Pool View'),(11,2,'С видом на парк','Park View'),(11,3,'С видом на море','Sea View'),(11,4,'С видом на город','City View'),(11,5,'С видом на горы','Mountain View'),(11,6,'С видом на океан','Ocean View'),(11,7,'Без четко определенного вида','Run of house'),(12,1,'Молодежные туры',NULL),(12,2,'Семейные туры',NULL),(12,3,'Романтические туры',NULL),(12,4,'Школьные туры',NULL),(12,5,'Авторские туры',NULL),(13,1,'Оформлен',NULL),(13,2,'Оплачен',NULL),(13,3,'Закрыт',NULL),(13,4,'Аннулирован',NULL);
...
-- Dump completed on 2022-06-21 18:59:34
