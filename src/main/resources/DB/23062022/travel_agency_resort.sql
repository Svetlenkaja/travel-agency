...
CREATE TABLE `resort` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_resort_country_id_idx` (`country_id`),
  CONSTRAINT `fk_resort_country_id` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`)
...
INSERT INTO `resort` VALUES (1,'Албена',1),(2,'Бургас',1),(3,'Солнечный берег',1),(4,'Анталия',2),(5,'Кушадасы',2);
